...
**Checkpoints & PLY files**: [Baidu NetDisk Link](https://pan.baidu.com/s/xxx) (code: xxxx)

## 🔗 Repository

[https://github.com/yourusername/pj3task1](https://github.com/yourusername/pj3task1)

## 📄 Report

See [`reports/task1_report.pdf`](reports/task1_report.pdf) for the full experiment report.

## 📝 License

Academic use only. This project is part of a university course assignment.
